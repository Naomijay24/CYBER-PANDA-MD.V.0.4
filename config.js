...
//
global.Owner = ["+254711660448"];         //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.OwnerNumber = ["+254711660448"];   //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.ownertag = ["+254711660448"];
global.OwnerName = "Techsavy";
global.BotName = "JayJay";
global.packname = "🦋 │𝐂𝐘𝐁𝜩𝐑│𝐏𝜟𝐍𝐃𝐀│𝐌𝐃│𝐕➂ 🦋";                             //Do not change.
global.author = "DRAKE";                               //Do not change.
